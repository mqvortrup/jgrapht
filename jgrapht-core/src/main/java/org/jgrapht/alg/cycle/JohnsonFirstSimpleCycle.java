...
/**
 * Find a first simple cycle of a directed graph using the Johnson's algorithm.
 *
 * <p>
 * See:<br>
 ...
 */
public class JohnsonFirstSimpleCycle<V, E>
    implements
    DirectedSimpleCycles<V, E>
{
     ...
     * null</code>.
     */
    public JohnsonFirstSimpleCycle(Graph<V, E> graph)
    {
    ...
    public List<List<V>> findSimpleCycles()
    {
        ...
        while (startIndex < size) {
            ...
            if (minSCCGResult != null) {
                ...
                if (findCyclesInSCG(startIndex, startIndex, scg)) {
                    break;
                }
                startIndex++;
            } else {
